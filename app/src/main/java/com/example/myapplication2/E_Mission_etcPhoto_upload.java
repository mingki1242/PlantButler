...
public class E_Mission_etcPhoto_upload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_mission_etc_photo_upload);
        ...
        regist_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(uri != null)
                {
                    ...
                    Toast.makeText(E_Mission_etcPhoto_upload.this , "사진을 선택해주세요" , Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    private void uploadToFirebase(Uri uri) {
        ...
        fileRef.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        Toast.makeText(E_Mission_etcPhoto_upload.this,"업로드 성공!!" , Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(E_Mission_etcPhoto_upload.this , "업로드 실패.." , Toast.LENGTH_SHORT).show();
            }
        });
